...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! ./test/main.js */1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/Users/liucong/projects/delight-ui/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/Users/liucong/projects/delight-ui/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	__webpack_require__(/*! ./styles/main.styl */ 160);
	
	var _ScrollableTest = __webpack_require__(/*! ./ScrollableTest */ 168);
	
	var _ScrollableTest2 = _interopRequireDefault(_ScrollableTest);
	
	var _TriggerTest = __webpack_require__(/*! ./TriggerTest */ 173);
	
	var _TriggerTest2 = _interopRequireDefault(_TriggerTest);
	
	var _DraggableTest = __webpack_require__(/*! ./DraggableTest */ 175);
	
	var _DraggableTest2 = _interopRequireDefault(_DraggableTest);
	
	var _TooltipTest = __webpack_require__(/*! ./TooltipTest */ 176);
	
	var _TooltipTest2 = _interopRequireDefault(_TooltipTest);
	
	var _SliderTest = __webpack_require__(/*! ./SliderTest */ 178);
	
	var _SliderTest2 = _interopRequireDefault(_SliderTest);
	
	var _SelectTest = __webpack_require__(/*! ./SelectTest */ 180);
	
	var _SelectTest2 = _interopRequireDefault(_SelectTest);
	
	var _AutoCompleteTest = __webpack_require__(/*! ./AutoCompleteTest */ 184);
	
	var _AutoCompleteTest2 = _interopRequireDefault(_AutoCompleteTest);
	
	var _ModalTest = __webpack_require__(/*! ./ModalTest */ 186);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader!./../../~/stylus-loader!./main.styl */ 161);
...
/* 161 */
/*!****************************************************************!*\
  !*** ./~/css-loader!./~/stylus-loader!./test/styles/main.styl ***!
  \****************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 163 */
/*!**********************************************!*\
  !*** ./test/styles/fonts/icomoon.eot?jh9e4u ***!
  \**********************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 164 */
/*!**********************************************!*\
  !*** ./test/styles/fonts/icomoon.ttf?jh9e4u ***!
  \**********************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 165 */
/*!***********************************************!*\
  !*** ./test/styles/fonts/icomoon.woff?jh9e4u ***!
  \***********************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 166 */
/*!**********************************************!*\
  !*** ./test/styles/fonts/icomoon.svg?jh9e4u ***!
  \**********************************************/
/***/ function(module, exports, __webpack_require__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Scrollable = __webpack_require__(/*! ../src/Scrollable */ 169);
	
	var _Scrollable2 = _interopRequireDefault(_Scrollable);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var ScrollableTest = _react2.default.createClass({
	    displayName: 'ScrollableTest',
	    render: function render() {
	        return _react2.default.createElement(
	            'div',
	            { className: 'scrollable-test' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Draggable = __webpack_require__(/*! ./Draggable */ 171);
	...
	var Scrollable = _react2.default.createClass({
	    ...
	    onResize: function onResize() {
	        ...
	        var size = isVeritical(this.props.orientation) ? panel.clientHeight : panel.clientWidth;
	
	        this.setState({
	            panelSize: size,
	            panelOffset: (0, _util.getOffset)(panel)
	        });
	    },
	    ...
	    componentDidUpdate: function componentDidUpdate(prevProps, prevState) {
	        ...
	        var panelSize = this.state.panelSize;
	
	
	        if (scrollSize !== prevProps.scrollSize || panelSize !== prevState.panelSize) {
	            this.syncThumbSize();
	        }
	    },
	    syncThumbSize: function syncThumbSize() {
	        var panel = this.refs.panel;
	        ...
	        var ratio = isVeritical(orientation) ? clientHeight / scrollHeight : clientWidth / scrollWidth;
	
	        var size = isVeritical(orientation) ? clientHeight : clientWidth;
	
	        var thumbSize = Math.round(size * ratio);
	
	        var state = {};
	
	        if (thumbSize === thumbSize && ratio !== 1) {
	        ...
	        state.ratio = ratio;
	        state.panelSize = isVeritical(orientation) ? clientHeight : clientWidth;
	    ...
	    onWheel: function onWheel(e) {
	        ...
	        var offset = isVeritical(orientation) ? scrollTop + deltaY : scrollLeft + deltaX;
	
	        this.scrollPanel(offset);
	
	        var realOffset = isVeritical(orientation) ? panel.scrollTop : panel.scrollLeft;
	
	        this.setState({
	            thumbOffset: realOffset * ratio
	        });
	    },
	    scrollPanel: function scrollPanel(offset) {
	        var panel = this.refs.panel;
	    ...
	    syncScroll: function syncScroll(offsetObject) {
	        var ratio = this.state.ratio;
	    ...
	    render: function render() {
	        ...
	        var showBar = _state.showBar;
	        var thumbSize = _state.thumbSize;
	        var thumbOffset = _state.thumbOffset;
	        var panelOffset = _state.panelOffset;
	
	
	        var panelStyle = isVeritical(orientation) ? { height: panelSize || '100%' } : { width: panelSize || '100%' };
	
	        var thumbStyle = isVeritical(orientation) ? { height: thumbSize, top: thumbOffset } : { width: thumbSize, left: thumbOffset };
	...
	Scrollable.propTypes = {
	    scrollSize: _react.PropTypes.number,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Draggable = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        var draggingClass = _props2.draggingClass;
	        ...
	        var childrenClassName = children.props.className;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getOffset(element) {
	    ...
	    var left = Math.round(element.getBoundingClientRect().left + document.body.scrollLeft);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Trigger = __webpack_require__(/*! ../src/Trigger */ 174);
	
	var _Trigger2 = _interopRequireDefault(_Trigger);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var TriggerTest = _react2.default.createClass({
	    displayName: 'TriggerTest',
	    render: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Trigger = _react2.default.createClass({
	    ...
	    componentWillUnmount: function componentWillUnmount() {
	        var _props = this.props;
	        var popupMountInside = _props.popupMountInside;
	        var getPopupContainer = _props.getPopupContainer;
	
	        var popupContainer = this.popupContainer;
	
	        if (!popupMountInside) {
	            (0, _reactDom.unmountComponentAtNode)(popupContainer);
	    ...
	    componentDidUpdate: function componentDidUpdate(prevProps, prevState) {
	        ...
	        var enterClass = _props2.enterClass;
	        var leaveClass = _props2.leaveClass;
	        var enterDuration = _props2.enterDuration;
	        var leaveDuration = _props2.leaveDuration;
	        var _props3 = this.props;
	        var popup = _props3.popup;
	        var getPopupContainer = _props3.getPopupContainer;
	        var isEntering = this.isEntering;
	        var isLeaving = this.isLeaving;
	        ...
	        if (this.popupRendered) {
	            var className = popup.props.className;
	            ...
	            (0, _reactDom.unstable_renderSubtreeIntoContainer)(this, popup, getPopupContainer());
	
	            if (isEntering) {
	                setTimeout(function () {
	                    _this.isEntering = false;
	                    _this.forceUpdate();
	                }, enterDuration);
	            } else if (isLeaving) {
	                setTimeout(function () {
	    ...
	    getPopupContainer: function getPopupContainer() {
	        var popupMountInside = this.props.popupMountInside;
	        var popupContainer = this.popupContainer;
	        ...
	        popupContainer = this.popupContainer = document.createElement('div');
	
	        if (popupMountInside) {
	            (0, _reactDom.findDOMNode)(this).appendChild(popupContainer);
	        } else {
	    ...
	    onMouseEnter: function onMouseEnter() {
	        var aboutToLeave = this.state.aboutToLeave;
	    ...
	    render: function render() {
	        ...
	        if (visible) {
	            triggerProps.className = children.props.className + ' ' + activeClass;
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Draggable = __webpack_require__(/*! ../src/Draggable */ 171);
	
	var _Draggable2 = _interopRequireDefault(_Draggable);
	
	var _util = __webpack_require__(/*! ../src/util */ 172);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var DraggableTest = _react2.default.createClass({
	    displayName: 'DraggableTest',
	    getInitialState: function getInitialState() {
	        return {
	            range: {
	                left: 0,
	    ...
	    componentDidMount: function componentDidMount() {
	        ...
	        var offset = (0, _util.getOffset)(playground);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Tooltip = __webpack_require__(/*! ../src/Tooltip */ 177);
	
	var _Tooltip2 = _interopRequireDefault(_Tooltip);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var TooltipTest = _react2.default.createClass({
	    displayName: 'TooltipTest',
	    render: function render() {
	        return _react2.default.createElement(
	            'div',
	            ...
	            _react2.default.createElement(
	                _Tooltip2.default,
	                { title: 'I\'m a tip on Bottom', placement: 'bottom', popupClassName: 'tooltip-popup bottom' },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'tooltip-trigger' },
	                    'Bottom'
	            ...
	            _react2.default.createElement(
	                _Tooltip2.default,
	                { title: 'I\'m a tip on Top Left', placement: 'topLeft' },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'tooltip-trigger' },
	                    'Top Left'
	            ...
	            _react2.default.createElement(
	                _Tooltip2.default,
	                { title: 'I\'m a tip on Top Right', placement: 'topRight' },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'tooltip-trigger' },
	                    'Top Right'
	            ...
	            _react2.default.createElement(
	                _Tooltip2.default,
	                { title: 'I\'m a tip on Bottom Left', placement: 'bottomLeft', popupClassName: 'tooltip-popup bottom' },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'tooltip-trigger' },
	                    'Bottom Left'
	            ...
	            _react2.default.createElement(
	                _Tooltip2.default,
	                { title: 'I\'m a tip on Bottom Right', placement: 'bottomRight', popupClassName: 'tooltip-popup bottom' },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'tooltip-trigger' },
	                    'Bottom Right'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Trigger = __webpack_require__(/*! ./Trigger */ 174);
	...
	var Popup = _react2.default.createClass({
	    ...
	    getStyle: function getStyle(props) {
	        ...
	        var center = triggerOffset.left + triggerDimension.width / 2 - width / 2;
	        var top = triggerOffset.top - height;
	        var bottom = triggerOffset.top + triggerDimension.height;
	        var left = triggerOffset.left;
	        var right = triggerOffset.left - (width - triggerDimension.width);
	...
	Popup.propTypes = {
	    className: _react.PropTypes.string,
	    triggerOffset: _react.PropTypes.object,
	    triggerDimension: _react.PropTypes.object,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Slider = __webpack_require__(/*! ../src/Slider */ 179);
	
	var _Slider2 = _interopRequireDefault(_Slider);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var SliderTest = _react2.default.createClass({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Tooltip = __webpack_require__(/*! ./Tooltip */ 177);
	...
	var Slider = _react2.default.createClass({
	    ...
	    getUnit: function getUnit(max) {
	        var orientation = this.props.orientation;
	        var step = this.refs.step;
	
	
	        if (isVeritical(orientation)) {
	            return (0, _util.divide)(step.clientHeight, max);
	        } else {
	            return (0, _util.divide)(step.clientWidth, max);
	        }
	    },
	    ...
	    render: function render() {
	        ...
	        var trackClassName = _props7.trackClassName;
	        ...
	        var shift = _state4.shift;
	        var holdOn = _state4.holdOn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Select = __webpack_require__(/*! ../src/Select */ 181);
	
	var _Select2 = _interopRequireDefault(_Select);
	
	var _selectPopupMixin = __webpack_require__(/*! ../src/selectPopupMixin */ 183);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SelectPopup = __webpack_require__(/*! ./SelectPopup */ 182);
	
	var _SelectPopup2 = _interopRequireDefault(_SelectPopup);
	...
	var Select = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        var defaultTitle = _props3.defaultTitle;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _selectPopupMixin = __webpack_require__(/*! ./selectPopupMixin */ 183);
	
	var _selectPopupMixin2 = _interopRequireDefault(_selectPopupMixin);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var SelectPopup = _react2.default.createClass({
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/liucong/projects/delight-ui/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "SelectPopup.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AutoComplete = __webpack_require__(/*! ../src/AutoComplete */ 185);
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/liucong/projects/delight-ui/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "AutoCompleteTest.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoComplete = _react2.default.createClass({
	    ...
	    getPopup: function getPopup() {
	        var _props = this.props;
	        var popupClassName = _props.popupClassName;
	        var itemClassName = _props.itemClassName;
	        var value = _props.value;
	        var activeClass = _props.activeClass;
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/liucong/projects/delight-ui/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "AutoComplete.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Modal = __webpack_require__(/*! ../src/Modal */ 187);
	
	var _Modal2 = _interopRequireDefault(_Modal);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var ModalTest = _react2.default.createClass({
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/liucong/projects/delight-ui/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "ModalTest.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PinCenter = __webpack_require__(/*! ./PinCenter */ 188);
	
	var _PinCenter2 = _interopRequireDefault(_PinCenter);
	...
	var Modal = _react2.default.createClass({
	    ...
	    componentDidUpdate: function componentDidUpdate(prevProps, prevState) {
	        ...
	        var children = _props.children;
	        var activeClass = _props.activeClass;
	        var maskClassName = _props.maskClassName;
	        var enterClass = _props.enterClass;
	        var leaveClass = _props.leaveClass;
	        var enterDuration = _props.enterDuration;
	        var leaveDuration = _props.leaveDuration;
	        var isEntering = this.isEntering;
	        var isLeaving = this.isLeaving;
	        var getModalContainer = this.props.getModalContainer;
	        ...
	        if (this.modalRendered) {
	            ...
	            var modal = _react2.default.cloneElement(children, { className: className });
	            ...
	            (0, _reactDom.unstable_renderSubtreeIntoContainer)(this, _react2.default.createElement(
	                ...
	                visible || isLeaving ? _react2.default.createElement('div', { className: maskClassName }) : null
	            ), getModalContainer());
	...
	Modal.propTypes = {
	    ...
	    getModalContainer: _react.PropTypes.func,
	    activeClass: _react.PropTypes.string
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PinCenter = _react2.default.createClass({
	    displayName: 'PinCenter',
	    getInitialState: function getInitialState() {
	        return {
	            marginLeft: 0,
	            marginTop: 0
	    ...
	    componentDidUpdate: function componentDidUpdate(prevProps, prevState) {
	        ...
	        var marginLeft = -(element.offsetWidth / 2);
	        var marginTop = -(element.offsetHeight / 2);
	
	        if (!prevState || marginTop !== prevState.marginTop || marginLeft !== prevState.marginLeft) {
	            this.setState({
	    ...
	    render: function render() {
	        ...
	        return _react2.default.cloneElement(this.props.children, { style: style });
	    }
	});
	...
	var TableTest = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'div',
	                { className: 'table-container resizable' },
	                _react2.default.createElement(_Table2.default, {
	                    className: 'table',
	                    dataSource: dataSource,
	                    colums: colums,
	                ...
	                _react2.default.createElement(
	                    ...
	                    colums.map(function (colume) {
	                        ...
	                        return _react2.default.createElement(
	                            ...
	                            title,
	                            resizable ? _react2.default.createElement('div', {
	                                className: 'resizer'
	                            }) : null
	                        );
	                    })
